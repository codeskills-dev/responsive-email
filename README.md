...
`span={2}` will result into a column that *has a width of two columns*.
...
Each column will wrap in the same way as `flex` itself would, this is a behavior inherent to tables.
